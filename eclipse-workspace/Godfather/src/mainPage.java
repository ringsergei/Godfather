...
public class mainPage {
	...
	private void initialize() {
		...
		this.width = Double.valueOf(screenSize.getWidth()).intValue();
		this.height = Double.valueOf(screenSize.getHeight()).intValue();
		...
		panel.setBackground(new Color(255,192,59));
		...
		lblNewLabel_3.setIcon(new ImageIcon("S:\\GitHubReps\\Godfather\\bluepill1.png"));
		...
		lblNewLabel_2.setIcon(new ImageIcon("S:\\GitHubReps\\Godfather\\redpill1.png"));
		...
		lblNewLabel_4.setIcon(new ImageIcon("S:\\GitHubReps\\Godfather\\left_hand.png"));
		lblNewLabel_4.setBounds((width/12)*4-80, (height/4)-80, 293, 357);
		panel_1.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5.setIcon(new ImageIcon("S:\\GitHubReps\\Godfather\\right_hand.png"));
